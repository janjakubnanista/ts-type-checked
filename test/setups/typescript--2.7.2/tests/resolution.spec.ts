...
describe('type resolution', () => {
  ...
  test('constructor types', () => {
    ...
    const validArbitrary: fc.Arbitrary<TypeReference1> = oneOf(instantiable);
  ...
  test('constructor types in unions', () => {
    ...
    const validArbitrary: fc.Arbitrary<TypeReference1> = oneOf<any>(instantiable, fc.string());
    const invalidArbitrary = oneOf(fc.anything().filter(notOfType('function', 'string')));
